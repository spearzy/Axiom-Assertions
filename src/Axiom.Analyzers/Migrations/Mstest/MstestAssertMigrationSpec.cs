...
internal enum MstestAssertMigrationKind
{
    ...
    Contain,
    NotContain,
    ContainExpectedFirst,
    NotContainExpectedFirst,
    ContainSubstring,
    ContainSubstringExpectedFirst,
    NotContainSubstringExpectedFirst,
    StartWith,
    StartWithExpectedFirst,
    EndWith,
    EndWithExpectedFirst,
    HaveUniqueItems,
    BeGreaterThan,
...
internal static class MstestAssertMigrationSpecs
{
    ...
    [
        ...
        new(
            AxiomAnalyzerIds.MigrateMstestAssertContainsSubstring,
            MstestAssertTarget.Assert,
            "Contains",
            2,
            MstestAssertMigrationKind.ContainSubstringExpectedFirst,
            "Migrate MSTest Assert.Contains string check to Axiom",
            "MSTest Assert.Contains(expectedSubstring, actual) can be migrated to 'actual.Should().Contain(expectedSubstring)'",
            "Convert to 'actual.Should().Contain(expectedSubstring)'"),
        new(
            AxiomAnalyzerIds.MigrateMstestAssertDoesNotContainSubstring,
            MstestAssertTarget.Assert,
            "DoesNotContain",
            2,
            MstestAssertMigrationKind.NotContainSubstringExpectedFirst,
            "Migrate MSTest Assert.DoesNotContain string check to Axiom",
            "MSTest Assert.DoesNotContain(unexpectedSubstring, actual) can be migrated to 'actual.Should().NotContain(unexpectedSubstring)'",
            "Convert to 'actual.Should().NotContain(unexpectedSubstring)'"),
        new(
            AxiomAnalyzerIds.MigrateMstestAssertStartsWith,
            MstestAssertTarget.Assert,
            "StartsWith",
            2,
            MstestAssertMigrationKind.StartWithExpectedFirst,
            "Migrate MSTest Assert.StartsWith to Axiom",
            "MSTest Assert.StartsWith(expectedPrefix, actual) can be migrated to 'actual.Should().StartWith(expectedPrefix)'",
            "Convert to 'actual.Should().StartWith(expectedPrefix)'"),
        new(
            AxiomAnalyzerIds.MigrateMstestAssertEndsWith,
            MstestAssertTarget.Assert,
            "EndsWith",
            2,
            MstestAssertMigrationKind.EndWithExpectedFirst,
            "Migrate MSTest Assert.EndsWith to Axiom",
            "MSTest Assert.EndsWith(expectedSuffix, actual) can be migrated to 'actual.Should().EndWith(expectedSuffix)'",
            "Convert to 'actual.Should().EndWith(expectedSuffix)'"),
        new(
            AxiomAnalyzerIds.MigrateMstestAssertContains,
            MstestAssertTarget.Assert,
            "Contains",
            2,
            MstestAssertMigrationKind.ContainExpectedFirst,
            "Migrate MSTest Assert.Contains collection check to Axiom",
            "MSTest Assert.Contains(expected, collection) can be migrated to 'collection.Should().Contain(expected)'",
            "Convert to 'collection.Should().Contain(expected)'"),
        new(
            AxiomAnalyzerIds.MigrateMstestAssertDoesNotContain,
            MstestAssertTarget.Assert,
            "DoesNotContain",
            2,
            MstestAssertMigrationKind.NotContainExpectedFirst,
            "Migrate MSTest Assert.DoesNotContain collection check to Axiom",
            "MSTest Assert.DoesNotContain(unexpected, collection) can be migrated to 'collection.Should().NotContain(unexpected)'",
            "Convert to 'collection.Should().NotContain(unexpected)'"),
        new(
            AxiomAnalyzerIds.MigrateMstestCollectionAssertAllItemsAreUnique,
            MstestAssertTarget.CollectionAssert,
            "AllItemsAreUnique",
            1,
            MstestAssertMigrationKind.HaveUniqueItems,
            "Migrate MSTest CollectionAssert.AllItemsAreUnique to Axiom",
            "MSTest CollectionAssert.AllItemsAreUnique(collection) can be migrated to 'collection.Should().HaveUniqueItems()'",
